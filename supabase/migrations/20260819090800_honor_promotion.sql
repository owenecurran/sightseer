-- Makes the promotion flags from the previous migration actually do
-- something: a promoted single day is treated as a trip everywhere, and a
-- promoted PAIR of reviews qualifies (the auto threshold of 3 stays in
-- place for anything the user hasn't confirmed).
