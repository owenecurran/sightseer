...
export const PROFILE_PROMPTS: ProfilePromptOption[] = [
  ...
  { slug: 'favorite-meal', label: 'Favorite meal I’ve had on a trip', category: 'food' },
  { slug: 'bucket-list', label: 'Bucket list destination I’m dying to visit', category: 'planning' },
  { slug: 'best-travel-companion', label: 'Best travel companion I’ve had', category: 'reflection' },
  { slug: 'view-meal', label: 'Best view I’ve had while eating', category: 'food' },
  { slug: 'best-travel-mistake', label: 'Best travel mistake I’ve made', category: 'reflection' },
  { slug: 'favorite-local-dish', label: 'Favorite local dish I’ve tried', category: 'food' },
  { slug: 'retirement-destination', label: 'Retirement destination I dream about', category: 'planning' },
  { slug: 'best-travel-moment', label: 'Best travel moment I’ve had', category: 'reflection' },
  { slug: 'best-sunset', label: 'Best sunset I’ve seen', category: 'reflection' },
  { slug: 'ball-knowledge', label: 'Elite ball knowledge', category: 'discovery' },
  { slug: 'hike-worth', label: 'Worth the hike', category: 'discovery' },
  { slug: 'go-to-group', label: 'My go-to group travel destination', category: 'planning' },
];
